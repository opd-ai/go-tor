...
### Core Protocol
- **[CERTS_IMPLEMENTATION.md](CERTS_IMPLEMENTATION.md)** - CERTS cell authentication
...
- **[STREAM_FLOW_CONTROL_INTEGRATION.md](STREAM_FLOW_CONTROL_INTEGRATION.md)** - Stream flow control
...
- **[CONTROL_GETINFO_ENHANCEMENT.md](CONTROL_GETINFO_ENHANCEMENT.md)** - GETINFO enhancements

### Onion Services
- **[CLIENT_AUTH_IMPLEMENTATION.md](CLIENT_AUTH_IMPLEMENTATION.md)** - Client authorization
- **[HSDIR_PUBLISHING_IMPLEMENTATION.md](HSDIR_PUBLISHING_IMPLEMENTATION.md)** - HSDir publishing
- **[ONION_RELAY_IMPLEMENTATION.md](ONION_RELAY_IMPLEMENTATION.md)** - Onion relay
- **[ONION_SERVICE_INTEGRATION_TESTS.md](ONION_SERVICE_INTEGRATION_TESTS.md)** - Integration tests

### Path Selection
- **[BANDWIDTH_WEIGHTED_SELECTION.md](BANDWIDTH_WEIGHTED_SELECTION.md)** - Bandwidth-weighted selection
- **[DIVERSITY_INTEGRATION.md](DIVERSITY_INTEGRATION.md)** - Geographic diversity
...
### Security
- **[CERTIFICATE_PINNING_IMPLEMENTATION.md](CERTIFICATE_PINNING_IMPLEMENTATION.md)** - Certificate pinning
