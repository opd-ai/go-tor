...
- Binary size: < 15MB (14MB unstripped, 9.4MB stripped) ✅ **Validated**
...
### Examples
See [examples/](examples/) directory for 27 working demonstrations covering all major features, including:
