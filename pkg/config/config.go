...
type Config struct {
	...
	CircuitCreationsPerSecond      float64 // Max circuit creations per second (default: 10)
	CircuitCreationsBurst          int     // Burst capacity for circuit creations (default: 5)
	MaxConcurrentConnections       int     // Max concurrent SOCKS connections (default: 1000)
	StreamBufferHighWaterMark      int     // High water mark for stream buffer (default: 65536)
	StreamBufferLowWaterMark       int     // Low water mark for stream buffer (default: 16384)
